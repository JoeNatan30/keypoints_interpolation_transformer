...
class augmentation():
    ...
    def __init__(self, body_type_identifiers, body_section_dict):
        ...
        self.BODY_IDENTIFIERS = body_type_identifiers['pose'] + body_type_identifiers['left_hand'] + body_type_identifiers['rigth_hand']
    ...
    def augment_shear(self, sign: dict, type: str, squeeze_ratio: tuple) -> dict:
        ...
        sign[:,self.BODY_IDENTIFIERS,:] = torch.tensor(augmented_landmarks).float()
